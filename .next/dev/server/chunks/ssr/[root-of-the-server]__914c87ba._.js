...
;
const ollama = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ollama$2f$dist$2f$browser$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Ollama"]({
...
class VectorStore {
    ...
    async searchByVector(vector, limit = 5, similarity = 0.8) {
        if (!this.db) throw new Error('VectorStore not initialized');
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$orama$2f$orama$2f$dist$2f$methods$2f$search$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["search"])(this.db, {
            mode: 'vector',
            vector: {
...
const useStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        searchNodes: async (query)=>{
            if (!query) return [];
            try {
                const queryEmbedding = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ollama$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getEmbedding"])(query);
                const results = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$vectorStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vectorStore"].searchByVector(queryEmbedding);
        ...
        getRelatedNodes: async (nodeId)=>{
            const node = get().nodes.find((n)=>n.id === nodeId);
            if (!node || !node.embedding) return [];
            try {
                const results = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$vectorStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vectorStore"].searchByVector(node.embedding, 6, 0.1);
                return results.hits.filter((hit)=>hit.document.id !== nodeId).map((hit)=>hit.document);
            } catch (error) {
...
const SearchBar = ()=>{
    ...
    const searchNodes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStore"])((s)=>s.searchNodes);
...
"[project]/src/components/InsightsPanel.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const InsightsPanel = ()=>{
    ...
    const [relatedNodes, setRelatedNodes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const getRelatedNodes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStore"])((s)=>s.getRelatedNodes);
    const addEdge = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStore"])((s)=>s.onConnect);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$react$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useOnSelectionChange"])({
        onChange: ({ nodes })=>{
            if (nodes.length === 1) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "absolute bottom-4 right-4 z-[10] w-[250px] bg-white rounded-lg shadow-xl border p-4 text-black",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                className: "font-bold text-sm border-b pb-2 mb-2",
                children: "Related Thoughts"
            }, void 0, false, {
                fileName: "[project]/src/components/InsightsPanel.tsx",
                lineNumber: 43,
                columnNumber: 7
            }, ("TURBOPACK compile-time value", void 0)),
            relatedNodes.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "text-xs text-gray-500 italic",
                children: "No similar thoughts found."
            }, void 0, false, {
                fileName: "[project]/src/components/InsightsPanel.tsx",
                lineNumber: 45,
                columnNumber: 9
                ...
                children: relatedNodes.map((node)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$InsightsPanel$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/InsightsPanel.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$react$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactFlow"], {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$InsightsPanel$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                        fileName: "[project]/src/components/Canvas.tsx",
                        lineNumber: 67,
                        columnNumber: 9
                    }, ("TURBOPACK compile-time value", void 0)),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__914c87ba._.js.map